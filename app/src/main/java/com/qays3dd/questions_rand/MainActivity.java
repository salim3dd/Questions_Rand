package com.qays3dd.questions_rand;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        qu = findViewById(R.id.textView_qu);
        An_1 = findViewById(R.id.textView_an1);
        An_2 = findViewById(R.id.textView_an2);
        An_3 = findViewById(R.id.textView_an3);
